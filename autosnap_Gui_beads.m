function varargout = autosnap_Gui_beads(varargin)
% AUTOSNAP_GUI_BEADS MATLAB code for autosnap_Gui_beads.fig
%      AUTOSNAP_GUI_BEADS, by itself, creates a new AUTOSNAP_GUI_BEADS or raises the existing
%      singleton*.
%
%      H = AUTOSNAP_GUI_BEADS returns the handle to a new AUTOSNAP_GUI_BEADS or the handle to
%      the existing singleton*.
%
%      AUTOSNAP_GUI_BEADS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AUTOSNAP_GUI_BEADS.M with the given input arguments.
%
%      AUTOSNAP_GUI_BEADS('Property','Value',...) creates a new AUTOSNAP_GUI_BEADS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before autosnap_Gui_beads_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to autosnap_Gui_beads_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help autosnap_Gui_beads

% Last Modified by GUIDE v2.5 01-Mar-2016 15:57:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @autosnap_Gui_beads_OpeningFcn, ...
                   'gui_OutputFcn',  @autosnap_Gui_beads_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before autosnap_Gui_beads is made visible.
function autosnap_Gui_beads_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to autosnap_Gui_beads (see VARARGIN)

% Choose default command line output for autosnap_Gui_beads
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes autosnap_Gui_beads wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = autosnap_Gui_beads_OutputFcn(hObject, eventdata, handles) 
...
if handles.pads==0
    ...
    autosnap_beta_beads(handles.pads,handles.number_of_pos, handles.posname, handles.cstring, get(handles.output_folder, 'String'), handels.posname_title, get(handles.auto_print,'Value'))
end
