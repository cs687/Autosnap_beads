function [ output_args ] = autosnap_beta_beads(pads, positions, padnames, colors, outputfolder,fname_title,auto_print)
...
for i=1:pads
    ...
    redsegbeads_auto(fname, 'naturalback',1);
    num_col=length(colors);
    Intensityheatmap_final_auto_2(fname,colors,fname_title{i});
    
    %analysesnaphist_auto_beads(fname,colors,fname_title);
